...
# # Set Hugging Face cache folders to a writable location
...
# # CONFIGURATION
# # ========================
# HF_REPO_ID = "Patohh254/mt5_swahili_QA"
# MODEL_FILENAME = None  
...
# FASTAPI APP
# ========================
app = FastAPI(title="Swahili QA API", description="Answer Swahili questions from context")
